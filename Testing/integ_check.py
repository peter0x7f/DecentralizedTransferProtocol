...
if __name__ == "__main__":
    REPO_PATH = '/path/to/your/local/repo'  # change to local Git repository path
    REPO_URL = 'https://github.com/peter0x7f/DecentralizedTransferProtocol/'  # Remote repository URL
